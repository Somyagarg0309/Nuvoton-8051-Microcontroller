...
sbit LED8 = P2^6;  // Row 3, Column 2
sbit LED9 = P2^1;  // Row 3, Column 3

sbit LED10 = P2^5; // Row 4, Column 1
...
void Delay(void) {
    int i, j;
    for (i = 0; i < 3000; i++) {  // Outer loop for delay
...
void displayDigit3(void) {
    ...
    LED10 = 1; LED11 = 1; LED12 = 1;  // Fourth row for digit 3
}
...
void displayDigit7(void) {
    LED1 = 1; LED2 = 1; LED3 = 1;  // First row
    LED4 = 0; LED5 = 0; LED6 = 1;  // Second row
    LED7 = 0; LED8 = 0; LED9 = 1;  // Third row
    LED10 = 0; LED11 = 0; LED12 = 1;  // Fourth row for digit 7
}
